...
class OrdersClose extends StatefulWidget {
  const OrdersClose({Key? key}) : super(key: key);

  @override
  _OrdersCloseState createState() => _OrdersCloseState();
}

class _OrdersCloseState extends State<OrdersClose> {
  String? ph;
  String? phn;
  @override
  void initState() {
  ...
  getPostsData() async {
    closeOrderList = await GetOrders(apiToken);
    setState(()  {
      mainDataList = closeOrderList;
    });
  }
              ...
              children: [
                Expanded(
                  child: ListView(
                    ...
                    children: closeOrderList.map((data) {
                      return Card(
                        ...
                        child: ListTile(
                            ...
                            onTap: () {
                              ...
                              print("selectedDataModel===>");
                              print(selectedDataModel.Status);
                              print(selectedDataModel.FullName);
